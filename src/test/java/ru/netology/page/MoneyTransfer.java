...
public class MoneyTransfer {
    ...
    public void transferMoney(DataHelper.CardsInfo cardNumber, String amount) {
        popUpString.val(amount);
        from.val(cardNumber.getNumber());
        popUpButton.click();
    }

    public DashboardPage makeValidTransfer(DataHelper.CardsInfo cardNumber, String amount) {
